...
?>
        ...
        <option name="pekerjaan" value="benteng">Membenahi Galengan/Benteng | Rp. 130.000</option>
        <option name="pekerjaan" value="perawatan">Perawatan | Rp. 80.000</option>
        <option name="pekerjaan" value="menanam">Menanam | Rp. 80.000</option>
        <option name="pekerjaan" value="memanen">Memanen | Rp. 7.000</option>
    </select></td></tr><tr>
    <div class="form-group"> <td>Jumlah Orang</td>
                        <td>: <input type="text" class="form-control-input" name="a1"></td></tr>
                        <tr>
    <div class="form-group"> <td></td><td>: <input type="text" class="form-control-input" name="a2" placeholder=" . . rante / kaleng / hari"></td></tr>
                    ...
                    <td></td><td>
                    <div class="form-group">
                        <button type="submit" name="submit" class="form-control-submit-button">Pesan</button>
                    </div></td></tr>
                    <tr>
