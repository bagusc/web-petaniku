        ...
        <!-- end of navigation -->
                ...
                while($d = mysqli_fetch_array($data)){
                    ...
                    <td><img src="../assets/img/<?php echo $d['gambar'] ?>" width="800px" height="200px"></td>
                        <td style=" padding-bottom: 2px; padding-left: 15px;" align="left"><br><b style="font-size:20px;" ><?php echo $d['judul'];  ?></b>
                        <br style="font-size:15px;"><?php echo substr($isi, 0, 280);  ?><br>
