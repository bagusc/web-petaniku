            ...
            <div class="cards"><br><br>
                ...
                <br><?php 
                  ?><br>
                    <form>
                    <table>
                        <tr valign="top"><th width="30%"><div class="form-group">Nama pemesan</th><td>: <?php echo $result['namebuyer']; ?></td></tr>
                        ...
                        <tr><th  colspan="2"><br><br><div class="form-group">
                            ...
                            <tr valign="top"><th><div class="form-group">No Seller</th><td>:         <?php 
        $seller = $result['id_seller'];
        $query    =mysqli_query($conn, "SELECT * FROM users WHERE id_users='$seller'");
        $result    =mysqli_fetch_array($query);
       echo $result['telp'];
        ?></td></tr>
                    </div></th></tr></table>
