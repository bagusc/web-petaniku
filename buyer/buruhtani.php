    ...
    <body>
        ...
        <!-- end of navigation -->
                    ...
                    <div class="container"><br><br><center>
                        <br><br><br><br><h3>Pesanan Pekerjaan Buruh Tani</h3><br>
                    </div> <center>
                ...
                $data = mysqli_query($conn,"select * from jasa where category_jasa=1");
                while($d = mysqli_fetch_array($data)){
                    ?>

                    <div class="box all">
                        <p style="padding-bottom: 50px; padding-left: 35px;" align="left">
                        <br><b>Nama Keompok : </b><?php echo $d['nama_kelompok'];  ?>
                        <br><b>Jumlah : </b><?php echo $d['jumlah_kelompok'];  ?>
                        <br><b>Keterangan : </b><?php echo $d['keterangan'];   ?>
                        </p>
                        <a href="form.php?id_pesan=<?=$d['id_jasa']?>" style="padding: 10px 60px; color: white; background-color:#252936;">
                            Pesan
                        </a>
